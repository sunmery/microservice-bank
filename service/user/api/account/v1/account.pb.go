...
func (x *GetAccountReply) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetAccountReply) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *GetAccountReply) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *GetAccountReply) GetBalance() int64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
func (x *GetAccountReply) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
var file_account_v1_account_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa4, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xfa, 0x42, 0x06, 0x72, 0x04, 0x10,
	0x02, 0x18, 0x14, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x32, 0x77, 0x0a,
	0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x65, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x21, 0x2e,
	...
	0x1a, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x22, 0x13, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0d, 0x12, 0x0b, 0x2f, 0x76, 0x31, 0x2f, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x18, 0x5a, 0x16, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x61,
...
var file_account_v1_account_proto_goTypes = []any{
	(*GetAccountRequest)(nil), // 0: api.account.v1.GetAccountRequest
	(*GetAccountReply)(nil),   // 1: api.account.v1.GetAccountReply
}
var file_account_v1_account_proto_depIdxs = []int32{
	0, // 0: api.account.v1.AccountService.GetAccount:input_type -> api.account.v1.GetAccountRequest
	1, // 1: api.account.v1.AccountService.GetAccount:output_type -> api.account.v1.GetAccountReply
