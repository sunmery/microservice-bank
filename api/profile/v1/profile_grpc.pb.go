...
const (
	Profile_CreateProfile_FullMethodName = "/app.user.api.profile.v1.Profile/CreateProfile"
	Profile_UpdateProfile_FullMethodName = "/app.user.api.profile.v1.Profile/UpdateProfile"
	Profile_DeleteProfile_FullMethodName = "/app.user.api.profile.v1.Profile/DeleteProfile"
	Profile_GetProfile_FullMethodName    = "/app.user.api.profile.v1.Profile/GetProfile"
	Profile_ListProfile_FullMethodName   = "/app.user.api.profile.v1.Profile/ListProfile"
)
...
var Profile_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "app.user.api.profile.v1.Profile",
